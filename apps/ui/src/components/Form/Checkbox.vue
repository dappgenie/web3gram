...
<template>
  <label class="cursor-pointer label flex items-center justify-start  text-sm text-white">
...
.shadow-light {
  ...
  filter: drop-shadow(0px -1px 1px #FFFFFF) drop-shadow(1px 1px 2px rgba(0, 0, 0, 0.25)) drop-shadow(1px 1px 3px rgba(198, 216, 255, 0.25));
}
.shadow-dark {
  @apply hover:shadow-btn-hover dark:hover:shadow-btn-dark-hover;
  filter: drop-shadow(-1px -1px 1px rgba(107, 107, 107, 0.25)) drop-shadow(1px 1px 1px #0C0C0C);
}
