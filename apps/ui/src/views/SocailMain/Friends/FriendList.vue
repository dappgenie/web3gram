<template>
    <div class="row">
      <div class="col-md-6" v-for="(item,index) in friends" :key="index">
        <iq-card body-class="profile-page p-0 card-body">
          <template v-slot:body>
            <div class="profile-header-image">
              <div class="cover-container">
                <img :src="item.backgroudimg" alt="profile-bg" class="rounded img-fluid w-100" loading="lazy">
              </div>
                    ...
                    <div class="profile-detail d-flex">
                      ...
                      <div class="user-data-block mt-md-0 mt-2">
                        <h4 class="text-primary">
                          <a href="/friendprofile"> {{item.name}}</a>
                         </h4>
