                    ...
                    <div class="user-post-data p-3">
                      <div class="d-flex flex-wrap">
                        <div class="media-support-user-img mr-3">
                          <b-img rounded="circle" fluid :src="require('../../assets/images/user/user-1.jpg')" alt=""/>
                        </div>
                  ...
                  <div class="comment-area p-3">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="iq-media-group">
                          <!-- <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid :src="require('../../assets/images/user/user-1.jpg')" alt="" />
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid :src="require('../../assets/images/user/user-2.jpg')" alt="" />
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid :src="require('../../assets/images/user/user-3.jpg')" alt="" />
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid :src="require('../../assets/images/user/user-4.jpg')" alt="" />
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid :src="require('../../assets/images/user/user-5.jpg')" alt="" />
                          </b-link> -->
                        </div>
                    ...
                    <ul class="post-comments p-0 m-0">
                      <li class="mb-2">
                        <div class="d-flex flex-wrap">
                          <div class="user-img">
                            <b-img :src="require('../../assets/images/user/user-2.jpg')" alt="userimg" class="avatar-35" rounded="circle" fluid />
                          </div>
                      ...
                      <li>
                        <div class="d-flex flex-wrap">
                          <div class="user-img">
                            <b-img :src="require('../../assets/images/user/user-3.jpg')" alt="userimg" class="avatar-35" rounded="circle" fluid />
                          </div>
                          <div class="comment-data-block ml-3">
                            <h6>Paul Molive</h6>
                            <p class="mb-0">Lorem ipsum dolor sit amet</p>
                ...
                <iq-card body-class="p-0">
                  <template v-slot:body>
                    <div class="user-post-data p-3">
                      <div class="d-flex flex-wrap">
                        <div class="media-support-user-img mr-3">
                          <b-img rounded="circle" fluid :src="require('../../assets/images/user/user-2.jpg')" alt="" />
                        </div>
                        <div class="media-support-info mt-2">
            ...
            <iq-card>
              ...
              <template v-slot:body>
                <div class="about-info m-0 p-0">
                  <div class="row">
                    <div class="col-12"><p>{{user.about}}</p></div>
                    <div class="col-3">Email: </div>
                    <!-- <div class="col-9"><b-link v-bind:href="user.email"> nikjone@demoo.com </b-link></div> -->
                    <div class="col-3">Phone:</div>
                    <!-- <div class="col-9"><b-link v-bind:href="user.phone">001 2351 256 12</b-link></div> -->
  ...
  data () {
    return {
      ...
      friends: [
        ...
        { name: 'Anna Mull', role: 'Web Developer', image: require('../../assets/images/user/user-2.jpg') },
        { name: 'Paige Turner', role: 'trainee', image: require('../../assets/images/user/user-3.jpg') },
        { name: 'Barb Ackue', role: 'Web Designer', image: require('../../assets/images/user/user-4.jpg') },
        { name: 'Greta Life', role: 'Tester', image: require('../../assets/images/user/user-5.jpg') },
        { name: 'Ira Membrit', role: 'Android Developer', image: require('../../assets/images/user/user-6.jpg') },
        { name: 'Pete Sariya', role: 'Web Designer', image: require('../../assets/images/user/user-6.jpg') }
      ],
      userBio: [
      ...
      suggestions: [
        { name: 'Paul Molive', mutual_friend: '4 mutual friends', image: require('../../assets/images/user/user-1.jpg') },
        { name: 'Paul Molive', mutual_friend: '4 mutual friends', image: require('../../assets/images/user/user-1.jpg') },
        { name: 'Anna Mull', mutual_friend: '6 mutual friends', image: require('../../assets/images/user/user-2.jpg') },
        { name: 'Paige Turner', mutual_friend: '8 mutual friends', image: require('../../assets/images/user/user-3.jpg') },
        { name: 'Barb Ackue', mutual_friend: '1 mutual friends', image: require('../../assets/images/user/user-4.jpg') },
        { name: 'Greta Life', mutual_friend: '3 mutual friends', image: require('../../assets/images/user/user-5.jpg') },
        { name: 'Ira Membrit', mutual_friend: '12 mutual friends', image: require('../../assets/images/user/user-6.jpg') },
        { name: 'Pete Sariya', mutual_friend: '2 mutual friends', image: require('../../assets/images/user/user-6.jpg') }
      ],
      news: [
